    ...
    <section className=" econt ">
      <div className="container">
        ...
        <div className="row text-center textt">
          <div className="col-md-12 col-sm-6 col-md-3 escondite1 animated fadeInLeft" >
            {/* <img className='pngs' src={html} /> */}
            <i className="devicon-html5-plain jqicon"></i>
            <p className="curso">HTML</p>
            <div className="ch-info-back me-escondo1">
              <h3 className="h3spac">HTML</h3>
          ...
          <div className="col-md-12 col-sm-6 col-md-3 escondite1  animated fadeInUp">
            ...
            <i className="devicon-react-original jqicon"></i>
